...
<script>
  export default {
    ...
    data() {
      return {
        sta:[{goal:'专栏',icon:'bili-read'},{goal:'直播',icon:'bili-live'},{goal:'活动',icon:'bili-active'},{goal:'专题',icon:'bili-special'},{goal:'小黑屋',icon:'bili-blackhome'},{goal:'音乐Plus',icon:'bili-misic'}],
